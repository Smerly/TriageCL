			...
			<section>
				...
				>
					...
					<nav
						...
						style={{ borderRadius: 5, width: 1000, paddingLeft: 100 }}
					>
						{/* <button
						...
						<ul className="navbar-nav">
							<div className="row">
								...
								<li className="nav-item pl-5 col-sm d-flex align-items-center">
									<NavLink
										whileHover={{ color: 'black' }}
										to={`/cart`}
					...
					<div className="row">
						<div className="col-md" style={{ marginTop: 200, marginLeft: 300 }}>
							<h1
								className="triage"
								style={{
									fontSize: '4vw',
